...
BEGIN
    ...
    INSERT INTO CHINHANH (TENCN, DIACHI, SDT, GIODM, GIODONGCUA) VALUES (@TENCN, @DIACHI, @SDT, @GIODM, @GIODONGCUA);
...
BEGIN
    ...
    UPDATE CHINHANH SET TENCN = @TENCN, DIACHI = @DIACHI, SDT = @SDT, GIODM = @GIODM, GIODONGCUA = @GIODONGCUA 
    WHERE MACN = @MACN;
...
CREATE PROCEDURE sp_Sub_LichSu_PhanCong
    @MACN INT, @MANV INT, @NGAYBATDAU DATE, @NGAYKETTHUC DATE
AS
BEGIN
